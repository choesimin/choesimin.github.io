---
layout: note
title: Simple Factory - 객체 생성을 캡슐화하기
version: 2023-05-18
---
...
- Simple Factory는 객체를 생성하는 부분을 캡슐화합니다.
...
| 장점 | 단점 |
| - | - |
| 객체를 생성하기 위한 method를 실행시키기 위해서 객체의 instance를 만들지 않아도 됩니다. | subclass를 만들어서 객체 생성 method의 행동을 변경시킬 수 없습니다. |


### Interface를 사용하는 개발과 Simple Factory
