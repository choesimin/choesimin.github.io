...
- 병행 제어는 여러 사용자가 동시에 데이터베이스에 접근하는 것을 허용하는 동시성(concurrency)을 제어하는 기술입니다.
- 동시성 제어는 데이터의 일관성(consistency)을 유지하면서 여러 사용자가 데이터베이스에 접근하는 것을 허용하는 것을 의미합니다.
- 동시성 제어는 데이터의 일관성을 유지하면서 여러 사용자가 데이터베이스에 접근하는 것을 허용하는 것을 의미합니다.
