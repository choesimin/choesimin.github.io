...
- Debezium은 **Lock 전략, Transaction Isolation, Memory 관리**로 snapshot 안정성을 보장합니다.
...
- Debezium은 **batch 처리와 chunk 처리로 memory 사용량을 조절**합니다.
...
- snapshot 수행 전 **lock 전략, memory, disk, network 설정을 사전 점검**해야 합니다.
