...
layout: note
permalink: /419
title: 자산 Class - 투자 범주에 따른 자산 분류
description: 자산 class는 현금, 채권, 주식, 부동산, 상품, 대체투자로 구분되며, 각 class는 서로 다른 수익-위험 특성과 경제 환경 반응을 가집니다.
date: 2025-11-12
published: false
---
...
- **자산 class(asset class)**는 **유사한 특성과 시장 행동을 공유하는 자산들의 범주**입니다.
    - 투자 목적, 위험 수준, 수익 pattern이 비슷한 자산들을 묶어서 분류합니다.
    - 각 자산 class는 서로 다른 경제 환경에서 다르게 반응합니다.

- 자산 class별 특성을 이해하면 **portfolio 다각화와 위험 관리**에 도움이 됩니다.
    - 서로 다른 자산 class에 분산 투자하면 전체 portfolio의 변동성이 줄어듭니다.
...
- **주식(stock, equity)**은 **기업의 소유권을 나타내는 증권**으로, 장기적으로 다른 자산 class보다 높은 평균 수익률을 보이지만 변동성도 큽니다.
...
- **대체투자(alternative investment)**는 **현금, 채권, 주식 등 전통적 자산 class를 제외한 모든 투자**로, 높은 수익 잠재력과 낮은 유동성이 특징입니다.
...
- 각 자산 class는 수익률, 위험, 유동성, inflation 대응력에서 서로 다른 특성을 보입니다.

| 자산 Class | 평균 수익률 | 위험 수준 | 유동성 | inflation 대응 |
| --- | --- | --- | --- | --- |
...
- 효과적인 portfolio는 여러 자산 class를 조합하여 구성하며, 투자자의 성향과 경제 상황에 따라 비율을 조정합니다.
