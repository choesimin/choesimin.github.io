...
- 자산을 분류하는 이유는 **투자 의사 결정과 portfolio 관리를 효과적으로 하기 위함**입니다.
...
- **투자 목표에 맞는 portfolio를 구성**할 수 있습니다.
...
- **여러 자산을 함께 보유하면 위험을 줄일 수 있습니다**.
    - 상관 관계가 낮은 자산들이 서로 다른 시간에 움직이므로, 전체 portfolio의 변동성이 낮아집니다.
...
- **위험 조절** : 안전 자산의 비중을 높이면 portfolio의 변동성이 낮아집니다.
