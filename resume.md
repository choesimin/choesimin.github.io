...
**Team Tech Stack** : `Java`, `Spring Boot`, `MyBatis`, `MySQL`, `AWS`, `Git`, `GitLab`.
...
- 정산 원장 관리, 결제 건의 정산 수수료 계산, 결제 취소 건의 상계 정산, 정산 보류 등 **정산 핵심 업무 규칙**을 구현하였습니다.
...
관리자 사이트 신규 버전의 API를 개발했습니다.
기존은 노드였음. 자바로 옮김.

- 회원, 사업장, 상담, 결제 내역 등에 대한 CRUD를 구현하였습니다.
- **카드 가맹 심사** 과정을 추가하여 심사 프로세스를 고도화하였습니다.
- 카드 가맹 대행비 결제 프로세스를 개발하였습니다.
