...
- **API 설계**를 맡아 진행하였습니다. API 명세가 화면에 의존하지 않도록 도메인과 기능 별로 나누어서, 여러 화면에서 재사용할 수 있도록 했습니다. 프론트엔드 개발자와 더 효율적으로 소통하기 위해 **정산 API 명세서**를 작성했습니다.
...
또한 공부한 내용을 주기적으로 공유하는 **"숏픈(Short-Open) 세미나"**에 참여해 [**시스템 설계**](https://www.simin.im/skills#system-design)를 주제로 발표하고 서로 의견을 나누기도 하였습니다.
...
- AWS에서 제공하는 다양한 클라우드 서비스를 이용하여 **웹 서비스를 호스팅**하는 기본적인 내용부터, 실제 비즈니스 환경에서 필수적인 **오토 스케일링**, **로드 밸런싱** 등의 기능을 구현하는 방법을 실습하였습니다.
...
필요한 기술은 주저하지 않고 배웁니다. 주로 **백엔드 개발 지식**을, 취미로 **프론트엔드 개발 지식**을 공부합니다.  
...
- **Java**와 **Spring Boot**를 능숙하게 사용할 수 있습니다.
- **TypeScript**, **JavaScript**를 사용하여 간단한 기능을 구현할 수 있습니다.

- **Java 및 Spring Boot**: 고급 수준의 Java 프로그래밍 기술과 Spring Boot를 활용한 웹 애플리케이션 개발에 능숙합니다. RESTful 서비스 구축, 데이터베이스 통합, 보안 강화 기능 구현 등 다양한 백엔드 작업을 수행할 수 있습니다. 이를 통해 효율적이고 유지보수가 용이한 서버 사이드 솔루션을 제공할 수 있습니다.
- **TypeScript 및 JavaScript**: TypeScript와 JavaScript를 사용하여 동적인 웹 프론트엔드 기능을 개발할 수 있는 기술을 보유하고 있습니다.
...
- [HTML, CSS, JavaScript를 사용하여 기초적인 수준의 **Interactive Graphic**을 구현할 수 있습니다.](https://www.simin.im/graphics)
